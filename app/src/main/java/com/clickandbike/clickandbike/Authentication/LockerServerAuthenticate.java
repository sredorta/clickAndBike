...
public class LockerServerAuthenticate implements ServerAuthenticate {
    ...
    @Override
    public String userSignUp(String name, String email, String password, String authType) {
        String authtoken = new CloudFetchr().userSignUp(name,email,password, "users");
        return authtoken;
    }
